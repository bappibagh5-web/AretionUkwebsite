      ...
      <div className="container mx-auto py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex items-start space-x-2 text-sm opacity-80 mb-2">
              <Mail size={16} className="mt-1 flex-shrink-0" />
              <a href="mailto:contact@aretion.org" className="hover:opacity-100 transition-opacity">
                contact@aretion.org
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="text-sm space-y-2 opacity-80">
              <p>
                <strong>ARETION & Company</strong><br />
